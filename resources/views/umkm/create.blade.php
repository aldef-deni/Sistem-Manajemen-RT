...
<div class="space-y-4">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 style="font-size:1.25rem;font-weight:700;color:#0f172a">Tambah UMKM</h1>
                <div style="display:flex;align-items:center;gap:6px;font-size:0.8rem;color:#64748b">
                    ...
                    <span>/</span>
                    <span style="color:#475569">Tambah</span>
                </div>
            </div>
        </div>
    ...
    {{-- Form --}}
    <form action="{{ route('umkm.store') }}" method="POST" enctype="multipart/form-data" style="display:flex;gap:24px">
        @csrf
        <div style="flex:1;display:flex;flex-direction:column;gap:20px">
            ...
            <div style="background:white;border-radius:14px;padding:24px;border:1px solid #e2e8f0">
                ...
                <div style="margin-bottom:16px">
                    ...
                    <input type="text" name="pemilik_display" value="{{ Auth::user()->name }}" readonly style="width:100%;padding:10px 14px;border-radius:10px;border:1px solid #e2e8f0;font-size:0.85rem;background:#f8fafc;color:#64748b">
                    <p style="font-size:0.7rem;color:#94a3b8;margin:4px 0 0 0">Nama pemilik dari akun yang login</p>
                </div>
