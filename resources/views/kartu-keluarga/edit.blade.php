            ...
            <div class="p-6 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-6">
                        ...
                        <input type="text" name="no_kk" value="{{ old('no_kk', $kartu_keluarga->no_kk) }}" maxlength="20" required
        ...
        <div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden mb-6">
            ...
            <div class="p-6">
                        ...
                        <tbody id="anggotaBody">
                            @foreach ($kartu_keluarga->anggota as $i => $a)
                                <tr class="anggota-row border-b border-slate-100">
                                    ...
                                    <td class="px-3 py-2">
                                        <input type="text" name="anggota[{{ $i }}][nik]" value="{{ $a->nik }}" maxlength="16" required placeholder="16 digit"
                                    ...
                                    <td class="px-3 py-2">
                                        <select name="anggota[{{ $i }}][role]"
                                                class="w-full px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500">
                                            @foreach(['Warga','Admin'] as $opt)
                                                <option value="{{ $opt }}" {{ $a->role === $opt ? 'selected' : '' }}>{{ $opt }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td class="px-3 py-2">
                ...
                <div class="mt-4 flex items-start gap-2 p-3 bg-blue-50 border border-blue-100 rounded-lg">
                    ...
                    <p class="text-xs text-blue-600">Setiap anggota baru otomatis mendapat akun login dengan <strong>Username = NIK</strong> dan <strong>Password = password</strong>. Role default: <strong>Warga</strong>.</p>
                </div>
            </div>
        </div>
