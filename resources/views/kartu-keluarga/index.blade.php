            ...
            <table class="w-full">
                <thead>
                    <tr class="bg-slate-50/80">
                        ...
                        <th class="px-4 py-3 text-center text-xs font-semibold text-slate-500 uppercase tracking-wider whitespace-nowrap">File KK</th>
                ...
                <tbody class="divide-y divide-slate-100">                        @forelse ($kartuKeluargas as $kk)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-4 py-3 text-center">
                                @if($kk->file_kk_url)
                                    @if($kk->file_kk_is_image)
                                        <a href="{{ $kk->file_kk_url }}" target="_blank" title="Lihat Kartu Keluarga">
                                            <img src="{{ $kk->file_kk_url }}" class="h-12 w-16 object-cover rounded-lg border border-slate-200 shadow-sm mx-auto" alt="KK {{ $kk->no_kk }}">
                                        </a>
                                    @else
                                        <a href="{{ $kk->file_kk_url }}" target="_blank" class="inline-flex items-center gap-1 px-2 py-1 bg-red-50 text-red-600 text-[10px] font-semibold rounded-md hover:bg-red-100" title="Buka PDF Kartu Keluarga">
