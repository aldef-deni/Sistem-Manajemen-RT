...
/*
|--------------------------------------------------------------------------
| Semua pengguna yang sudah masuk — termasuk warga
|--------------------------------------------------------------------------
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('kegiatan-rt', [KegiatanRTController::class, 'index'])->name('kegiatan-rt.index');
    ...
    | Pengurus RT ke atas
    |----------------------------------------------------------------------
    | Seluruh pengelolaan operasional: kependudukan, keuangan, inventaris,
    | layanan, dan dokumentasi.
    */
    Route::middleware('role:admin,ketua,pengurus')->group(function () {
        ...
        // --- Tabungan --- (rute literal wajib di atas rute berparameter)
        ...
        // --- Bantuan sosial --- (get-warga wajib di atas {penerimaBantuan})
        ...
        // --- Kegiatan RT (kelola) ---
        Route::get('kegiatan-rt/create', [KegiatanRTController::class, 'create'])->name('kegiatan-rt.create');
        Route::post('kegiatan-rt', [KegiatanRTController::class, 'store'])->name('kegiatan-rt.store');
        Route::get('kegiatan-rt/{kegiatanRt}/edit', [KegiatanRTController::class, 'edit'])->name('kegiatan-rt.edit');
        Route::put('kegiatan-rt/{kegiatanRt}', [KegiatanRTController::class, 'update'])->name('kegiatan-rt.update');
        Route::delete('kegiatan-rt/{kegiatanRt}', [KegiatanRTController::class, 'destroy'])->name('kegiatan-rt.destroy');

        // --- Notulen rapat (kelola) ---
    ...
    */
    ...
    /*
    |----------------------------------------------------------------------
    | Halaman detail — diletakkan paling akhir supaya tidak menelan
    | rute literal seperti /pengumuman/create di atasnya.
    |----------------------------------------------------------------------
    */
    Route::get('pengumuman/{pengumuman}', [PengumumanController::class, 'show'])->name('pengumuman.show');
    Route::get('jadwal-kegiatan/{jadwalKegiatan}', [JadwalKegiatanController::class, 'show'])->name('jadwal-kegiatan.show');
    Route::get('kegiatan-rt/{kegiatanRt}', [KegiatanRTController::class, 'show'])->name('kegiatan-rt.show');
    ...
    |----------------------------------------------------------------------
    | Nama halaman dipakai sebagai URL literal, jadi PageController
